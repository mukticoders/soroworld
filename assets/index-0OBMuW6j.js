 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,j){var Q=D.length;D.push(j);e:for(;0<Q;){var ae=Q-1>>>1,Me=D[ae];if(0<r(Me,j))D[ae]=j,D[Q]=Me,Q=ae;else break e}}function n(D){return D.length===0?null:D[0]}function i(D){if(D.length===0)return null;var j=D[0],Q=D.pop();if(Q!==j){D[0]=Q;e:for(var ae=0,Me=D.length,Ve=Me>>>1;ae<Ve;){var H=2*(ae+1)-1,ne=D[H],he=H+1,fe=D[he];if(0>r(ne,Q))he<Me&&0>r(fe,ne)?(D[ae]=fe,D[he]=Q,ae=he):(D[ae]=ne,D[H]=Q,ae=H);else if(he<Me&&0>r(fe,Q))D[ae]=fe,D[he]=Q,ae=he;else break e}}return j}function r(D,j){var Q=D.sortIndex-j.sortIndex;return Q!==0?Q:D.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],f=1,d=null,h=3,m=!1,v=!1,x=!1,p=typeof setTimeout=="function"?setTimeout:null,u=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(D){for(var j=n(c);j!==null;){if(j.callback===null)i(c);else if(j.startTime<=D)i(c),j.sortIndex=j.expirationTime,e(l,j);else break;j=n(c)}}function y(D){if(x=!1,_(D),!v)if(n(l)!==null)v=!0,G(R);else{var j=n(c);j!==null&&$(y,j.startTime-D)}}function R(D,j){v=!1,x&&(x=!1,u(P),P=-1),m=!0;var Q=h;try{for(_(j),d=n(l);d!==null&&(!(d.expirationTime>j)||D&&!L());){var ae=d.callback;if(typeof ae=="function"){d.callback=null,h=d.priorityLevel;var Me=ae(d.expirationTime<=j);j=t.unstable_now(),typeof Me=="function"?d.callback=Me:d===n(l)&&i(l),_(j)}else i(l);d=n(l)}if(d!==null)var Ve=!0;else{var H=n(c);H!==null&&$(y,H.startTime-j),Ve=!1}return Ve}finally{d=null,h=Q,m=!1}}var A=!1,w=null,P=-1,T=5,S=-1;function L(){return!(t.unstable_now()-S<T)}function V(){if(w!==null){var D=t.unstable_now();S=D;var j=!0;try{j=w(!0,D)}finally{j?z():(A=!1,w=null)}}else A=!1}var z;if(typeof g=="function")z=function(){g(V)};else if(typeof MessageChannel<"u"){var X=new MessageChannel,W=X.port2;X.port1.onmessage=V,z=function(){W.postMessage(null)}}else z=function(){p(V,0)};function G(D){w=D,A||(A=!0,z())}function $(D,j){P=p(function(){D(t.unstable_now())},j)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){v||m||(v=!0,G(R))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(D){switch(h){case 1:case 2:case 3:var j=3;break;default:j=h}var Q=h;h=j;try{return D()}finally{h=Q}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,j){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var Q=h;h=D;try{return j()}finally{h=Q}},t.unstable_scheduleCallback=function(D,j,Q){var ae=t.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?ae+Q:ae):Q=ae,D){case 1:var Me=-1;break;case 2:Me=250;break;case 5:Me=1073741823;break;case 4:Me=1e4;break;default:Me=5e3}return Me=Q+Me,D={id:f++,callback:j,priorityLevel:D,startTime:Q,expirationTime:Me,sortIndex:-1},Q>ae?(D.sortIndex=Q,e(c,D),n(l)===null&&D===n(c)&&(x?(u(P),P=-1):x=!0,$(y,Q-ae))):(D.sortIndex=Me,e(l,D),v||m||(v=!0,G(R))),D},t.unstable_shouldYield=L,t.unstable_wrapCallback=function(D){var j=h;return function(){var Q=h;h=j;try{return D.apply(this,arguments)}finally{h=Q}}}})(Mg);Sg.exports=Mg;var $0=Sg.exports;/**
 * @license React
